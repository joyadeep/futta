...
const Driver = () => {
  ...
  return (
    <div className='mt-5 h-full w-full static ' >
      {/* <div className='bg-slate-200 text-right pr-1'> */}
        <button className='fixed top-1 right-3 bg-green-500 px-4 py-2 rounded-md text-white ml-auto'>Create Driver</button>
      {/* </div> */}
